...
type Page = 'home' | 'contact' | 'learn-more' | 'labor-tracker' | 'qfaen' | 'nexa' | 'marven' | 'team' | 'smartbox';
...
export default function App() {
  ...
  if (currentPage === 'learn-more') {
    return <LearnMorePage onNavigate={navigateTo} />;
  }

  if (currentPage === 'labor-tracker') {
    return <LaborTrackerPage onNavigate={navigateTo} />;
  }

  if (currentPage === 'qfaen') {
    return <QfaenPage onNavigate={navigateTo} />;
  }

  if (currentPage === 'nexa') {
    return <NexaPage onNavigate={navigateTo} />;
  }

  if (currentPage === 'marven') {
    return <MarvenPage onNavigate={navigateTo} />;
  }
        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105"
            >
      ...
      <section className="min-h-screen flex items-center justify-center p-8 bg-gradient-to-br from-black via-blue-950 to-slate-900 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <button 
              onClick={() => navigateTo('labor-tracker')}
            ...
            >
              ...
              <div className="flex items-center justify-between relative z-10">
                ...
                <span className="text-sm text-slate-500">95% Complete</span>
              </div>
            </button>

            <button 
              onClick={() => navigateTo('qfaen')}
